...
Task(subagent_type="aidlc-for-claude:aidlc-graph-analyzer", model="sonnet",
     prompt="Run graph analysis in standalone mode. Ask the user which operation they want: build, update, visualize, or impact analysis. Then execute the selected operation on the current workspace.")
```
