...
| `/aidlc-graph` | Build, update, visualize, export (PNG), search, repair, verify, or tear down code dependency graphs (File/Neo4j/Neptune) with optional GraphRAG and CGIG |
