...
- :material-graph-outline: Li et al. (2025). [GraphCodeAgent: Dual Graph-Guided LLM Agent for Retrieval-Augmented Repo-Level Code Generation](https://arxiv.org/abs/2504.10046). *arXiv:2504.10046*. -- Structural-Semantic Code Graph (SSCG) for repo-level code generation.
- :material-graph-outline: Ren et al. (2026). RPG-Encoder: Learning Repository Structure for Code Completion via Graph Encoding. *ICSE 2026*. -- Incremental graph-based representations of repository evolution.
- :material-bug: Ke et al. (2025). CGM: Compilation-Guided Code Generation with LLMs. *ISSTA 2025*. -- Compilation diagnostics to guide iterative code generation.
