...
| `/aidlc-graph` | UTILITY | Build, update, visualize, export (PNG), and search code dependency graphs (with optional GraphRAG) |
...
| `aidlc-for-claude:aidlc-graph-analyzer` | Code dependency graph with multi-backend support (File/Neo4j/Neptune), impact analysis, visualization, PNG export, and GraphRAG summary-based retrieval |
